"""
scripts/models/external_validation/halo_rf_cosyne_external_validation_on_acdb.py

CosynE Random Forest baseline's external validation on the rest of the ACDB dataset
...
exp06d_rf_cosyne_out = MODEL_RESULTS / "exp06d_rf_cosyne_bin_nosspace_elementwise_reduced_nestedcv"
ext_out = RESULTS / "external_validation" / "external_validation_acdb_rf_cosyne"
